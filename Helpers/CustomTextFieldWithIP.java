...
public class CustomTextFieldWithIP extends JFormattedTextField{
    ...
    public CustomTextFieldWithIP(){
        super(new IPAddressFormatter());
    }
    
    public CustomTextFieldWithIP(int columns) {
        super(columns);
